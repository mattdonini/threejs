    ...
    element.addEventListener('click', () => {
        ...
        if (modelUrl) {
            ...
            const transitionOut = () => {
                ...
                glitchPass.uniforms.uAmount.value = 0.5 * easedProgress;
                glitchPass.uniforms.uChromAbb.value = 0.5 * easedProgress;
                glitchPass.uniforms.uGlitch.value = 0.5 * easedProgress;
