...
const adjustModelScale = () => {
    if (model) {
        ...
        const scaleFactorWidth = isMobile ? sizes.width / 900 : sizes.width / 1200;
        const scaleFactorHeight = isMobile ? sizes.height / 900 : sizes.height / 1200;
        ...
        if (modelUrl) {
            ...
            const transitionIn = () => {
                ...
                const transition = () => {
                    ...
                    pixelationPass.uniforms.pixelSize.value = 0.016 * easedProgress;
                    noisePass.uniforms.noiseStrength.value = 0.5 * easedProgress;
